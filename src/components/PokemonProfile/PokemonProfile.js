                ...
                <section className="pokemon-profile">
                    <div className="pokemon__container">
                        <div className="pokemon__image">
                            <img
                                src={`https://github.com/PokeAPI/sprites/raw/master/sprites/pokemon/other/official-artwork/${this.props.match.params.pokemonId}.png`}
                        ...
                        <div className="pokemon__info">
                            ...
                            <span
                                className="pokemon__ceil-info">{this.props.pokemon.name && this.toUpperCaseFirstLetter(this.props.pokemon.name)}</span>
                            ...
                            <span
                                className="pokemon__ceil-info">{this.props.pokemon.types && this.toUpperCaseFirstLetter(this.props.pokemon.types[0].type.name)}</span>
                            ...
                            <span className="pokemon__ceil-info"><progress className="pokemon__progress-info"
                                                                           value={this.props.pokemon.stats && this.props.pokemon.stats[0].base_stat}
                                                                           max="100"/></span>
                            <span className="pokemon__ceil-info">Attack:</span>
                            <span className="pokemon__ceil-info"><progress className="pokemon__progress-info"
                                                                           value={this.props.pokemon.stats && this.props.pokemon.stats[1].base_stat}
                                                                           max="100"/></span>
                            <span className="pokemon__ceil-info">Defense:</span>
                            <span className="pokemon__ceil-info"><progress className="pokemon__progress-info"
                                                                           value={this.props.pokemon.stats && this.props.pokemon.stats[2].base_stat}
                                                                           max="100"/></span>
                            <span className="pokemon__ceil-info">Special attack:</span>
                            <span className="pokemon__ceil-info"><progress className="pokemon__progress-info"
                                                                           value={this.props.pokemon.stats && this.props.pokemon.stats[3].base_stat}
                                                                           max="100"/></span>
                            <span className="pokemon__ceil-info">Special defense:</span>
                            <span className="pokemon__ceil-info"><progress className="pokemon__progress-info"
                                                                           value={this.props.pokemon.stats && this.props.pokemon.stats[4].base_stat}
                                                                           max="100"/></span>
                            <span className="pokemon__ceil-info">Speed:</span>
                            <span className="pokemon__ceil-info"><progress className="pokemon__progress-info"
                                                                           value={this.props.pokemon.stats && this.props.pokemon.stats[5].base_stat}
                                                                           max="100"/></span>
                        </div>
                        <div className="pokemon__abilities">
                            <h2 className="pokemon-profile__header">Abilities:</h2>
                            <span
                                className="pokemon__abilities-list">{this.props.pokemon.abilities && this.pokemonListAbilities()}</span>
                        </div>
                    </div>
                </section>
            </>
